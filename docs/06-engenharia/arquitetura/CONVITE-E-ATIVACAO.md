...
5. Se qualquer etapa depois da reivindicação falhar (ex.: e-mail em uso), o convite volta a `PENDENTE` (best-effort) para que o aluno possa tentar de novo com um link ainda válido.
